...
function quizPageSubmit(direction="forward")
{
	...
	//console.log("got as far as this");
	...
	jQuery.ajax({
		...
		success: function(data){
			...
			var x = setInterval(function() {
				...
				if(hours>=1)
				{
				  feedback =  hours + "h " + minutes + "m " + seconds + "s ";
				}
				else
				{
				  feedback =   minutes + "m " + seconds + "s ";
				}
				document.getElementById("quizTimeLimitRemaining").innerHTML = feedback;
